...
export const QuienesSomosSection = (): JSX.Element => (
  <RevealSection id="quienes-somos" aria-labelledby="quienes-somos-title">
    ...
    <div className="layout-stack-mobile mt-7 grid grid-cols-1 items-start gap-8 lg:mt-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,20rem)] lg:gap-10 xl:grid-cols-[minmax(0,1fr)_minmax(0,24rem)] xl:gap-14">
